...
export default function DashboardPage() {
  ...
  return <AppLayout><div className="mx-auto max-w-6xl space-y-5 pb-4 md:space-y-7">
    <section className="relative overflow-hidden rounded-[2rem] border border-blue-200/20 bg-[linear-gradient(130deg,#06142e,#123574_58%,#08152e)] p-5 shadow-2xl shadow-blue-950/40 md:p-8">
      <Image src="/dashboard-game-night-illustration.png" alt="Ilustración de una mesa con dominó, cartas españolas y parchís" fill priority className="object-cover object-[72%_center] opacity-90" />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(4,15,37,.98)_0%,rgba(6,21,46,.92)_42%,rgba(6,19,43,.35)_72%,rgba(6,19,43,.14)_100%)]" />
